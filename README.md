...
Практикум по **[Решению задач](https://code-basics.com)** (больше не доступен на площадке, однако задания доступны на [GitHub](https://github.com/akraeva/exercises-ruby.git))
